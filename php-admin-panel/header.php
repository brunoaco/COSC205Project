...
$menuItems = [
    [
        ...
        "icon" => "fas fa-home",
        "pages" => [
            ["title" => "Home", "url" => "index.php"],//here goes the menus on the side
            ["title" => "Venues", "url" => "venues.php"],
            ["title" => "Entertainment", "url" => "Entertainment.php"]
        ],
    ],
    /* [
         "menuTitle" => "Settings",
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info"><a href="./" class="d-block">I.S.O Talent</a></div>
        </div>
        <nav class="mt-2">
